...
Analyzes user prompts and recommends the most relevant Skills, Tools, and Agents.

## Parameters

| Parameter | Required | Description |
|-----------|----------|-------------|
| `PROMPT` | Yes | User's request text to analyze |
...
- WebFetch, WebSearch, NotebookEdit, KillShell
...
- step-by-step-agent - TodoWrite tracking
...
Output a ranked list of recommended tools.
