...
- **Skill-based for both providers**: Both Linear and Jira use dedicated skills (`linear-issue`, `jira-issue`) for consistent interface
...
| `jira` | Skills | `jira-issue`, `project-manage` |
